...
# =====================================================================
SYMBOL = "ETH-USD"  # Formato global Yahoo Finance inmune a geobloqueos
INTERVALO_SEGUNDOS = 60  

# Enlace de API indestructible que apunta al token de tu bot Bunker
URL_DIRECTA_TELEGRAM = "https://telegram.org"

# ID real de tu canal privado validado por Watson
...
# =====================================================================
# CONEXIONES BLINDADAS DE PRODUCCIÓN
# =====================================================================

def enviar_telegram(mensaje):
    """Despacha alertas directas y masivas al canal privado."""
    payload = {"chat_id": TELEGRAM_CHAT_ID, "text": mensaje, "parse_mode": "Markdown"}
    try: 
        res = requests.post(URL_DIRECTA_TELEGRAM, json=payload, timeout=5)
        if res.status_code != 200:
            print(f"❌ Error en API Telegram (Canal Privado): {res.text}")
        else:
            print("🟩 ¡ÉXITO! Alerta inyectada directamente en el Canal Privado.")
    except Exception as e: 
        print(f"❌ Fallo de red en enviar_telegram: {e}")

def obtener_datos_mercado():
    """Descarga de datos de mercado inmune a bloqueos de exchanges."""
    try:
...
# =====================================================================
# PERSISTENCIA EXIGIDA POR SERVIDORES NUBE (Render / Gunicorn)
# =====================================================================
