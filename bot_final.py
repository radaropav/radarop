...
def enviar_telegram(mensaje):
    ...
    # Cabeceras simuladas para evadir bloqueos en la pasarela de Telegram
    cabeceras = {
...
def obtener_datos_mercado():
    ...
    # Opción 1: API Global de CoinGecko (Inmune a bloqueos de exchanges de trading)
    try:
        ...
        # Opción 2: Binance API Pública Internacional (Si falla la anterior)
        try:
...
def ejecutar_bucle_radar():
    ...
    # Test instantáneo de diagnóstico al arrancar
...
# Iniciador seguro de subprocesos
arrancar_radar()

if __name__ == '__main__':
    # El servidor web vincula el puerto dinámico de Render automáticamente
